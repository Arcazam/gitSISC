...
p {
  ...
  font-weight: bolder;
    ...
    <!-- 이 위부터는 style과 script 설정입니다 -->
     ...
     String [] links = {"fiveMenu.bd?menu=notice", "fiveMenu.bd?menu=rank", "fiveMenu.bd?menu=survey", "fiveMenu.bd?menu=quiz", "fiveMenu.bd?menu=inquiry",};
     %>
     ...
     <table border=1 style="width: 1100px; height: 300px; margin:auto;">
        <tr>
