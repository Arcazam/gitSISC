...
<form name="insertMemberForm" method="post" action="insertMember.mb" enctype="multipart/form-data">
   <table border=1 class="insert">
      <tr>
         ...
         <td>
         <img src="<%=request.getContextPath()%>/resources/images/defaultImage.png" style="margin-left:22px; width:50px; height: 50px;"> 
      ...
      <tr>
         <th>아이디</th>
         <td>
         <input type="text" name="id" placeholder="닉네임이기도 해요!" style="width: 150px; height: 35px;">
      ...
      <tr>
      	 <th>비밀번호</th>
         <td>   
         <input type="text" name="password" style="width: 150px; height: 35px;">
         </td>
      </tr>
      ...
      <tr>
      	 <th>이름</th>
         <td>
         <input type="text" name="name" style="width: 150px; height: 35px;">
         </td>
      </tr>   
      ...
      <tr>
      	 <th>생년월일</th>
         <td>     
         <input type="date" name="birth" style="width: 130px; height: 35px;">
         </td>
      </tr>
      ...
      <tr>
      	 <th>주민등록번호</th>
         <td>
         <input type="text" name="joomin1" style="width: 130px; height: 35px;"> - 
         <input type="password" name="joomin2" style="width: 130px; height: 35px;">
         </td>
      </tr>
      ...
      <tr>
         ...
         <input type="text" name="hp2" size="6" style="height: 35px;"> -
         <input type="text" name="hp3" size="6" style="height: 35px;">
         </td>
      </tr>
