...
Object loginInfo = session.getAttribute("loginInfo");
	...
	<div class="floating-left">
  	<table border=1 class="boardTag">
		<tr>
			...
			<span style="font-family: 'TAEBAEKfont'; font-size: 1.5em;">지금 <font color="yellowgreen">인기태그</font>를 확인!</span>
			</td>
		</tr>
	...
	<c:forEach var="bd" items="${list }">
		<table border=1 class="boardMain">		
            <tr>
                <td class="boardTableTitle"><a id="boardText" style="font-size: 1.5em;" href = "detailList.bd?b_num=${bd.b_num }&ref=${bd.ref }&pageNumber=1&board=${boardConfirm}">${bd.subject }</a></td>
            </tr>
            
            <tr>
            	<td class="boardTableWriter"><b><span style="font-size: 1.5em; color: black;"><a id="boardText" href="">${bd.writer }</a></span></b></td>
            </tr>
