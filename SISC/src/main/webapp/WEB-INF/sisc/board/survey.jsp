...
<%@ include file="../top&bottom/top.jsp" %>
   ...
   <div>
   <form method="post" action="survey.su">
   <table class="rTable">
      <tr>
      ...
      <tr>
         <td>
         <textarea name="su_text1" rows="5" cols="115" style="resize: none;"></textarea>
         </td>
      </tr>
      ...
      <tr>
         <td>
         <textarea name="su_text2" rows="5" cols="115" style="resize: none;"></textarea>
         </td>
      </tr>
      ...
      <tr>
         <td>
         <textarea name="su_text3" rows="5" cols="115" style="resize: none;"></textarea>
         </td>
      </tr>
      ...
      <tr>
         <td>
         <textarea name="su_text4" rows="5" cols="115" style="resize: none;"></textarea>
         </td>
      </tr>
      ...
      <tr>
         <td>
         <textarea name="su_text5" rows="5" cols="115" style="resize: none;"></textarea>
         </td>
      </tr>
