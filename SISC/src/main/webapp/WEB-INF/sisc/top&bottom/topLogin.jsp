...
<body>
   <div class="top">
      ...
      <span class="top_menu" style="color: #ABF200;">학생<span class="space"></span><a href="SelectAllStudy.st?id=${loginInfo.id }&pro_img=${loginInfo.pro_img}" id="design" style="text-decoration-line: none;">${loginInfo.id }님</a></span>
      </c:if>																																	
      <c:if test="${loginInfo.division eq 'manager' }">
      <span class="top_menu" style="color: #030066;">매니저<span class="space"></span><a href="SelectAllStudy.st?id=${loginInfo.id }&pro_img=${loginInfo.pro_img}" id="design" style="text-decoration-line: none;">${loginInfo.id }님</a></span>
      </c:if>
      <c:if test="${loginInfo.division eq 'lecturer' }">
      <span class="top_menu" style="color: #FFBB00;">강사<span class="space"></span><a href="SelectAllStudy.st?id=${loginInfo.id }&pro_img=${loginInfo.pro_img}" id="design" style="text-decoration-line: none;">${loginInfo.id }님</a></span>
      </c:if>
   </div>
