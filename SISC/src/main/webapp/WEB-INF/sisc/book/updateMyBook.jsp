...
<div id="BookUpdateForm">
    ...
    <div class="updateContainer">
        <form:form name="BookUpdate" commandName="bb" action="updateMyBook.bk" method="post" enctype="multipart/form-data">
        <input type="hidden" name="bk_num" value="${bb.bk_num }">
        <input type="hidden" name="id" value="${mb.id }">
        <input type="hidden" name="seller" value="${writer}">
        <input type="hidden" name="bk_num" value="${bb.bk_num}">
        <input type="hidden" name="pro_img" value="${mb.pro_img}">
