        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
					...
					<div id="loginBoxTitle" style="font-size: 30px; margin-left: 45%;">Book Detail</div>
                    <!-- Topbar Navbar -->
				...
				<div class="container-fluid">
                    <div class="row">
                    	<table class="table" style="width: 50%; margin: auto; margin-top: 50px;">
						    <tr>
								<th colspan=2 style="text-align: center;">${ bb.bk_num }번의 책 정보</th>
							</tr>
							<tr>
								<th>판매자</th>
							...
							<tr>
								<th colspan=2 style="text-align: center;"> 
									<input type="button" value="회원 목록" class = "btn btn-primary" onClick="location.href='bookList.mag'">
