        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- 검색 폼: 게시판 검색 -->
					<form name="magBoardSearchForm" method="get" action="boardList.mag" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
					    <div class="input-group" style="width: 600px;">
					        <select name="b_cate" class="form-control bg-light border-0 small" style="width: 40px;">
					        ...
					        <select name="whatColumn" class="form-control bg-light border-0 small" style="width: 40px;">
						  ...
						  <c:if test="${ !empty blist }">
							<c:forEach var="bb" items="${ blist }">
								<tr align="center">
									...
									<td>${ bb.taglist }</td>
									<td>
										<input type="button" value="삭제" class="btn btn-primary" onClick="deleteBoard(${ bb.b_num },'${ bb.b_cate }','${ pageInfo.pageNumber }')">
									</td>
								</tr>
							</c:forEach>
						</c:if>
