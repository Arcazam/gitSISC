    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <center style="margin-top: 10px; margin-bottom: 30px;"><h1>공지사항 추가</h1></center>
			<form action="insertNotice.bd" method="post">
				<div class="container-fluid">
                    <div>
                    	<table class="table">
						  ...
						  <tr>
						  	<td>
						  		작성자 <input type="text" name="writer" value="admin" readonly="readonly">
						  	</td>
						  	<td>
						  		제목 <input type="text" name="subject">
						  	</td>
						  	<td>
						  		내용 <textarea rows="15" cols="30" name="content"></textarea>
						  	</td>
						  	<td>
