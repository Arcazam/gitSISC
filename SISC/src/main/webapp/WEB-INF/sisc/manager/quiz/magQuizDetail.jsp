                    	...
                    	<table class="table" style="width: 50%; margin: auto; margin-top: 50px;">
							...
							<tr>
								<th colspan=2 style="text-align: center;"> 
									<input type="button" value="회원 목록" class = "btn btn-primary" onClick="location.href='quizList.mag'">
									<input type="button" value="퀴즈 수정" class = "btn btn-info" onClick="location.href='quizUpdate.mag?qz_num=+${qb.qz_num }+&que_cate=${qb.que_cate }&pageNumber=${pageNumber }'">
