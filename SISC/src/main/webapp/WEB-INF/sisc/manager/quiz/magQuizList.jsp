        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- 검색 폼: 게시판 검색 -->
					<form name="magQuizSearchForm" method="get" action="quizList.mag" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
					    <div class="input-group" style="width: 600px;">
					        <select name="que_cate" class="form-control bg-light border-0 small" style="width: 10px;">
						  ...
						  <c:if test="${ !empty qlist }">
							<c:forEach var="qb" items="${ qlist }">
								<tr align="center">
									...
									<td>${ qb.answer }</td>
									<td>
										<input type="button" value="수정" class="btn btn-primary" onClick="updateQuiz(${ qb.qz_num },'${ qb.que_cate }',${ pageInfo.pageNumber })">
									</td>
									<td>
										<input type="button" value="삭제" class="btn btn-danger" onClick="deleteQuiz(${ qb.qz_num },'${ qb.que_cate }',${ pageInfo.pageNumber })">
									</td>
								</tr>
							</c:forEach>
						</c:if>
