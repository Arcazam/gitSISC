        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <form name="magMemberSearchForm" method="get" action="memberList.mag" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
					    <div class="input-group">
					        ...
					        <input type="text" name="keyword" class="form-control bg-light border-0 small" style="display: inline;">
                    ...
                    <div class="row">
						  ...
						  <c:if test="${ !empty mlist }">
							<c:forEach var="mb" items="${ mlist }">
								<tr scope="row" align="center">
									...
									<td>${ mb.curriculum }</td>
									<td>
										<input type="button" class="btn btn-primary" value="삭제" onClick="deleteMember('${ mb.id }',${ pageInfo.pageNumber })">
									</td>
								</tr>
							</c:forEach>
						</c:if>
						...
						<tr>
							<th align="right" colspan="9">
								<input type="button" class="btn btn-primary" style="margin-top: 30px;" value="선택한 항목 삭제" onClick="selectedDel()">
							</th>
						</tr>
						  </tbody>
						</table>
