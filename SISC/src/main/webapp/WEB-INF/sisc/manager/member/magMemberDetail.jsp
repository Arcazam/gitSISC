        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
					...
					<div id="loginBoxTitle" style="font-size: 30px; margin-left: 44%;">Member Detail</div>
                    <!-- Topbar Navbar -->
                    	...
                    	<table class="table" style="width: 50%; margin: auto; margin-top: 50px;">
                    		<tr>
                    			<th colspan=2 style="text-align: center;">
                    				<img id="profileImage" src="<%= request.getContextPath() %>/resources/member/${loginInfo.id}/pro_img/${loginInfo.pro_img}" />
                    			</th>
                    		</tr>
						    <tr>
								<th colspan=2 style="text-align: center;">${ mb.id }님의 정보</th>
							</tr>
							<tr>
								<th>비밀번호</th>
							...
							<tr>
								<th>교육기간</th>
								<td align="center">
									<fmt:parseDate value='${mb.start_day}' pattern="yyyy-MM-dd" var='start_day' /> 
									<fmt:formatDate value="${start_day}" pattern="yyyy-MM-dd" />~
									<fmt:parseDate value='${mb.end_day}' pattern="yyyy-MM-dd" var='end_day' /> 
							...
							<tr>
								<th colspan=2 style="text-align: center;"> 
									<input type="button" value="회원 목록" class = "btn btn-primary" onClick="location.href='memberList.mag'">
									<input type="button" value="회원 삭제" class = "btn btn-danger" onClick="toDelete('${ mb.id }',${pageNumber})">
								</th>
							</tr>
