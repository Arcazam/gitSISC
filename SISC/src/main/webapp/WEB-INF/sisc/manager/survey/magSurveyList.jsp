        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <form name="" method="get" action="" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
					    <div class="input-group">
					        <select name="whatColumn" class="form-control bg-light border-0 small">
					            <option value="all">전체검색</option>
					            <option value="su_text1">답변</option>
					        </select>
                ...
                <center style="margin-top: 10px; margin-bottom: 30px;"><h1>문의 리스트</h1></center>
