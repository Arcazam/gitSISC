...
public class BookInsertController {
	...
	public String toInsertBookProc(
		...
		/*	
java.io.IOException: Destination file [F:\쌍용강북\팀프로젝트\WorkSpace\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\SISC\resources\book] already exists and could not be deleted	*/
		// 오류 해결
