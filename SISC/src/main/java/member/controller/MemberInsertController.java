...
public class MemberInsertController {
	...
	public String tologinForm(MemberBean mb, @RequestParam(value = "address_main") String address_main,
			...
			@RequestParam(value = "joomin1") String joomin1, @RequestParam(value = "joomin2") String joomin2,
			@RequestParam(value = "hp1") String hp1, @RequestParam(value = "hp2") String hp2,
