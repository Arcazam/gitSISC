...
public class MagQuizPaging {
	...
	public MagQuizPaging(
			String _pageNumber, 
			String _pageSize,  
			int totalCount,
			String url, 
			String whatColumn, 
			String keyword, String que_cate) {		
		...
		} // 마지막 페이지에 하나가 있었는데 삭제했으면, 총 페이지를 계산된 페이지로 대입시킨다
	...
	private String getPagingHtml( String url ){ //페이징 문자열을 만든다.
		...
		String result = "" ;
		String added_param = "&whatColumn=" + whatColumn + "&keyword=" + keyword + "&que_cate=" + que_cate ;
